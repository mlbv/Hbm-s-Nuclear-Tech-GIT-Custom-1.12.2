...
public class RenderRBMKConsole extends TileEntitySpecialRenderer<TileEntityRBMKConsole> {
    ...
    private void renderColumns(TileEntityRBMKConsole console) {
    ...
    private void renderScreens(TileEntityRBMKConsole console) {
